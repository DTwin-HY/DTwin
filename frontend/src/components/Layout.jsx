...
const Layout = () => {
  ...
  return (
    <div
      ...
      style={isDashboard ? { backgroundColor: '#ffffff' } : {}}
    >
      <header
      ...
      >
        <h1
          className={
            isDashboard
              ? 'text-xl font-bold hover:cursor-pointer hover:opacity-70'
              : 'text-gradient text-xl font-bold hover:cursor-pointer hover:opacity-70'
          }
      ...
      <footer
        ...
        style={isDashboard ? { backgroundColor: '#ffffff', color: '#6b7280' } : {}}
      >
